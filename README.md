...
## Summary
This repository contains computational codes used in [Miyamoto et al., 2023](https://scholar.google.com/citations?user=L5_NEUsAAAAJ&hl=ja).
...
- input
  - Table S3.xlsx : Raw data available from [Miyamoto et al., 2023](https://scholar.google.com/citations?user=L5_NEUsAAAAJ&hl=ja).
- output
